...
public class MenuVisibility : MonoBehaviour {
	...
	void Update () {
        ...
        if (menuID != activeID)
        {
            ...
            if (myInput != null) { myInput.interactable = false; myInput.transform.position = new Vector3(myInput.transform.position.x, 9999, myInput.transform.position.z); }
        } else {
            ...
            if (myInput != null) { myInput.interactable = true; myInput.transform.position = new Vector3(myInput.transform.position.x, ystart, myInput.transform.position.z); }
        }
    }
}
